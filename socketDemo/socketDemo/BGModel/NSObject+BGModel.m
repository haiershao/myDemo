...
+(BOOL)bg_isExistWithName:(NSString *)name
{
    __block BOOL result;
    [[BGFMDB shareManager] isExistWithTableName:name complete:^(BOOL isSuccess) {
        result  = isSuccess;
    }];
    //关闭数据库
    [[BGFMDB shareManager] closeDB];
 ...
 */
+(void)bg_inTransaction:(BOOL (^_Nonnull)(void))block{
